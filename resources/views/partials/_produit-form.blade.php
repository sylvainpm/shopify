@csrf
    ...
    <div class="form-group">
      ...
      {{-- <input value="{{  old('designation') ?  old('designation') ?: $produit->designation}}" type="text" name="designation" id="designation" class="form-control" placeholder="" aria-describedby="helpId"> --}}
